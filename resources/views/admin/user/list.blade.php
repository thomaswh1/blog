        ...
        @foreach ($user as $v)
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('修改','{{url('admin/user/'.$v->user_id.'/edit')}}',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="详细信息"  onclick="x_admin_show('详细信息','{{url('admin/user/'.$v->user_id)}}',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe60a;</i>
              </a>
              <a onclick="x_admin_show('修改密码','{{url('admin/user/editpass/'.$v->user_id)}}',600,400)" title="修改密码" href="javascript:;">
                <i class="layui-icon">&#xe631;</i>
              </a>
