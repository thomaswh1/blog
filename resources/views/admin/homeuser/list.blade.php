<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" method="get" action="{{url('admin/homeuser')}}">
      ...
      <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加用户','{{url('admin/homeuser/create')}}',600,400)"><i class="layui-icon"></i>添加</button>
        <!-- {{--<span class="x-right" style="line-height:40px">共有数据：8 条</span>--}} -->
      </xblock>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
            $.post('/admin/homeuser/'+id,{"_method":"delete","_token":"{{csrf_token()}}"},function(data){
              // console.log(data);
              if(data.status==0){
