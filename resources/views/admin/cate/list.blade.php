          ...
          <tr>
            <td>
              <div class="layui-input-inline" style="width:35px">
                <input onchange="changeOrder(this,{{$v->cate_id}})" type="text" name="cate_order" class="layui-input" value="{{$v->cate_order}}">
              </div>
            </td>
            <td>{{$v->cate_id}}</td>
            <td>{{$v->cate_name}}</td>
            ...
            <td class="td-manage">
              <a title="编辑"  onclick="x_admin_show('修改','{{url('admin/cate/'.$v->cate_id.'/edit')}}',600,400)" href="javascript:;">
